...
def layer_stats(
    ...
    def get_ds():
        ...
        raw_ds = Dataset.from_file('/disk/disk_20T/share/wikipedia/20200501.en/1.0.0/009f923d9b6dd00c00c8cdc7f408f2b47f45dd4f5fb7982a21f9448f4afbe475/wikipedia-train.arrow')
        raw_ds = {'train': raw_ds}
        # raw_ds = load_dataset(
        #     ds_name,
    ...
    if 'gpt-j-6b' in model_name.lower():
        ...
        model_name = 'gpt2-xl'
    elif 'qwen2-7b' in model_name.lower():
        model_name = 'Qwen2-7B'
    file_extension = f"{model_name}/{ds_name}_stats/{layer_name}_{precision}_{'-'.join(sorted(to_collect))}{size_suffix}.npz"
    filename = stats_dir / file_extension
    print(filename)
    #/disk/disk_20T/xzk/collaedit_new/stats/gpt-j-6B/wikipedia_stats/transformer.h.3.mlp.fc_out_float32_mom2_100000.npz
    #/disk/disk_20T/xzk/collaedit_new/stats/gpt2-xl/wikipedia_stats/transformer.h.3.mlp.fc_out_float32_mom2_100000.npz
